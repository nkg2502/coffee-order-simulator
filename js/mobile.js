function addCoffee() {
  ...
  let $coffee= $('<select><option>Americano</option><option>Caramel Macchiato</option><option>Latte</option><option>Chocolate(S)</option><option>Chocolate</option><option>Vanilla Latte</option><option>Hazelnut Latte</option><option>Cappuccino</option><option>Mocha</option><option>Espresso</option><option>Sweet Sweet</option><option>Milk</option><option>Other</option></select>').addClass('form-control').attr('name', 'coffee');
